...
- Failed deliveries are retried up to 5 times with increasing delays: 30 seconds, 2 minutes, 10 minutes, then 1 hour. A delivery that exhausts its retries gets a last error ending in `(retries exhausted)`.
