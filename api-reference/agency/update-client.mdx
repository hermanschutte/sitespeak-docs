...
| reset_credits | Boolean | When `true`, the client's usage counter restarts now and their remaining credits become the full `message_limit`. Use for mid-cycle plan changes. |
