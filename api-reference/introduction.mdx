...
<CardGroup cols={2}>
  ...
  <Card title="Echo Fine-tunes" icon="sliders" href="/api-reference/echo/get-echo">
    Retrieve, create and delete echo fine-tunes
  </Card>
  <Card title="Leads" icon="user-plus" href="/api-reference/leads/get-leads">
    Retrieve leads captured by a chatbot
  </Card>
  <Card title="Prompts" icon="lightbulb" href="/api-reference/prompts/get-prompts">
    Retrieve the smart prompts for a chatbot
  </Card>
