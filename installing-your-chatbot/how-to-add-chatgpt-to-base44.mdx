...
You can learn more at: [base44](https://app.base44.com/)
...
We are going to use a prompt to instruct the base44 AI to insert the snippet for us.

2. Insert prompt into AI chatbox and click on **Send message**
