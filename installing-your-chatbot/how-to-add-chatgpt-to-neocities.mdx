...
This needs some precautions to be taken because if you make changes to your HTML code, it could have adversal effects on the status of your website.

We therefor suggest that when you have opened your website in the Page editor, copy your HTML code and save it offline in a text file as a backup incase something goes wrong during the edit process.
</Note>
